...
[base] = LAYOUT_65_ansi(
    ...
    KC_TAB,   KC_Q,    KC_W,   KC_E,   KC_R,           KC_T,   KC_Y,   SFT_U,  CTL_I,   ALT_O,   GUI_P,    KC_LBRC, KC_RBRC, KC_BSLS, LCTL_T(KC_HOME),
    CTL_ESC,  GUI_A,   ALT_S,  CTL_D,  SFT_F,          KC_G,   KC_H,   KC_J,   KC_K,    KC_L,    KC_SCLN,  KC_QUOT,          KC_ENT,  LSFT_T(KC_END),
...
[gaming] = LAYOUT_65_ansi(
    TO(0),   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_F12,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_U,    KC_I,    KC_O,    KC_P,    KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME,
    KC_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_TRNS, KC_TRNS, KC_J,    KC_K,    KC_L,    KC_SCLN, KC_TRNS,          KC_TRNS, KC_END,
